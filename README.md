...
**方块空间**是一个使用 **Kotlin + Jetpack Compose** 实现的 Android 原生单机俄罗斯方块应用。项目采用完整的 Gradle Wrapper，能够直接导入 Android Studio；同时随交付提供已构建并验证的调试版 APK。
...
| 游戏信息 | 实时展示得分、等级、消行数、下一个方块与落点虚影。 |
| 界面 | 深色霓虹游戏主题、圆角棋盘、方块高光和适用于触屏的双排大按钮。 |
