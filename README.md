...
| 状态管理 | 游戏结束覆盖层、暂停覆盖层、一键重新开始，以及从顶部齿轮进入的全屏实时键位编辑模式。方块落地后保留 500ms 锁定延迟；落地后的有效移动或旋转最多可重置 15 次，确保高重力阶段仍可操作。上一块锁定后，新方块会获得 120ms 的直降误触保护，避免残留点击误直降；移动、旋转和软降不会被阻塞。 |
...
| 包名 | `com.manus.tetris` |
| 应用名称 | 方块空间 |
| APK SHA-256 | `8ff67d4ace8158b00d23a1cf20a75660fd39889611b3fa0d3379dac567934999` |
