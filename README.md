...
| 界面 | 蓝色竖屏游戏厅布局，棋盘尺寸同时受可用宽度与高度约束，顶部、侧边信息和底部操作区可完整显示。普通下落与横移采用短时平滑过渡；直降具有瞬时金色反馈；锁定仅产生短促细微的蓝色边缘提示（不会泛白）；消行行闪白并带金色扫光；得分数字滚动、得分事件淡入缩放。 |
...
| 应用名称 | 方块空间 |
| APK SHA-256 | `2abafc56d64e46cec9f2f1cb83ca7dd257a7ccb4e24ec595ce31237d160f83e5` |
