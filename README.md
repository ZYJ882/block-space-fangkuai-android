...
| 界面 | 蓝色竖屏游戏厅布局，棋盘尺寸同时受可用宽度与高度约束，顶部、侧边信息和底部操作区可完整显示。普通下落与横移采用短时平滑过渡；普通落地与直降均不绘制任何全棋盘闪光；仅在实际消行时展示低亮度局部行提示；得分数字滚动、得分事件淡入缩放。 |
...
| 应用名称 | 方块空间 |
| APK SHA-256 | `ed21299af27840e360a4a7af66faf80a3bbcc478b5b3a93cd733b85c9e492470` |
