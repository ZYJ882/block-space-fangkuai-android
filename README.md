...
| 包名 | `com.manus.tetris` |
| 应用名称 | 方块空间 |
| APK SHA-256 | `468566b2eb57420ceb9fed63d7d7f3c4641899b65178c604a30f37693a1c6a34` |
...
| 直落 | 当前方块直接落至可放置的最低位置并立即固定；每跨越 1 格 +2 分。上一块锁定后，新方块的前 120ms 会忽略直降输入，以吸收残留点击；其他操作立即可用。 |
| 暂停 | 暂停或恢复自动下落。 |
| 重开 | 清空棋盘和得分，开启新的对局。 |
